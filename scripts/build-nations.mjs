...
fs.writeFileSync(path.join(root, "copa-do-mundo", "a-ultima-vez", "nations.data.js"),
  `// GENERATED by scripts/build-nations.mjs — do not edit. Canonical: data/nations.json\nwindow.NATIONS = ${json};\n`);
process.stdout.write(`\n[build] ✓ all ${gates.length} gates pass — wrote data/nations.json + copa-do-mundo/a-ultima-vez/nations.data.js (${nations.length} nations)\n`);
